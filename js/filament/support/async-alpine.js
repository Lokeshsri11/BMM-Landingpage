    ...
    (() => {
        ...
        var c = () => !0,
            ...
            v = ({
                ...
                if (e) window.addEventListener(e, () => i(), {
                    once: !0
                });
                else {
                    let n = a => {
            ...
            A = ({
                ...
                i.matches ? e() : i.addEventListener("change", e, {
                    once: !0
                })
            }),
            b = A,
        ...
        function q(t) {
            ...
            for (;
                ...
                if (a !== void 0) i.push({
                    ...
                    s.includes("(") && (p.method = s.substring(0, s.indexOf("(")).trim(), p.argument = s.substring(s.indexOf("(") + 1, s.indexOf(")"))), s.method === "immediate" && (s.method = "eager"), i.push(p)
                }
            }
            return i
        }
        ...
        var _ = "__internal_",
            l = {
                ...
                init(t, e = {}) {
                    return this.Alpine = t, this._options = { ...this._options,
                        ...e
                    }, this
                },
                start() {
                ...
                url(t, e) {
                    !t || !e || (this._data[t] || this.data(t), this._data[t].download = () =>
                ...
                _generateRequirements(t, e) {
                    if (e.type === "expression") {
                        if (e.operator === "&&") return Promise.all(e.parameters.map(i => this._generateRequirements(t, i)));
                        if (e.operator === "||") return Promise.any(e.parameters.map(i => this._generateRequirements(t, i)))
                    }
                    return o[e.method] ? o[e.method]({
                        component: t,
                        argument: e.argument
                    }) : !1
                },
                async _download(t) {
                    if (t.startsWith(_) || (this._handleAlias(t), !this._data[t] || this._data[t].loaded)) return;
                ...
                _activate(t) {
                    this.Alpine.destroyTree(t.el), t.el.removeAttribute(`${this._options.alpinePrefix}ignore`), t.el._x_ignore = !1, this.Alpine.initTree(t.el)
                },
                _mutations() {
                    new MutationObserver(t => {
                        for (let e of t)
                            if (e.addedNodes)
                                for (let i of e.addedNodes) i.nodeType === 1 && (i.hasAttribute(`${this._options.prefix}${this._options.root}`) && this._mutationEl(i), i.querySelectorAll(`[${this._options.prefix}${this._options.root}]`).forEach(n => this._mutationEl(n)))
                    }).observe(document, {
                        attributes: !0,
                        childList: !0,
                        subtree: !0
